    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alphabets_spinner_numeric_code.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                ((TextView) parent.getChildAt(0)).setTextColor(ForgotPasswordActivity.this.getResources().getColor(R.color.white));
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                            Toast.makeText(ForgotPasswordActivity.this, "it seems your network is slow" ,
                                    Toast.LENGTH_LONG).show();
                        } else if (error instanceof AuthFailureError) {
                            //TODO
                        } else if (error instanceof ServerError) {
                            Toast.makeText(ForgotPasswordActivity.this, "sorry for inconvenience, Server is not working" ,
                                    Toast.LENGTH_LONG).show();
            ...
            StringRequest stringRequestpasskey = new StringRequest(Request.Method.POST, PPASSKEY_URL,
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            pd.dismiss();
                            if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                                Toast.makeText(ForgotPasswordActivity.this, "it sesms your internet is slow" ,
                                        Toast.LENGTH_LONG).show();
                            } else if (error instanceof AuthFailureError) {
                                //TODO
                            } else if (error instanceof ServerError) {
                                ...
                                Toast.makeText(ForgotPasswordActivity.this, "it seems your internet is slow" ,
                                        Toast.LENGTH_LONG).show();
                            } else if (error instanceof ParseError) {
                                //TODO
                            }
