...
public class AnniversaryGifAdapter extends RecyclerView.Adapter<AnniversaryGifAdapter.ViewHolder> {
    Context context;
...
//    }
    ...
    public AnniversaryGifAdapter(Context context, ArrayList<AnniversaryGifModel> arrayList, Activity activity, FriendListInterface friendListInterface) {
    ...
    @NonNull
    @Override
    public AnniversaryGifAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AnniversaryGifAdapter.this.friendListInterface.sendGif(view ,holder.getAdapterPosition());
            }
        });
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AnniversaryGifAdapter.this.friendListInterface.sendGif(view, AnniversaryGifAdapter.ViewHolder.this.getAdapterPosition());
                }
            });
