...
public class GroupParticipantAdapter extends Adapter<GroupParticipantAdapter.GroupHolder> {
    ...
    public GroupParticipantAdapter(List<Member> memberslist2, boolean isAdminLogin,
    ...
    public void onBindViewHolder(@NonNull GroupHolder holder, final int position) {
        ...
        holder.group_members_name.setOnClickListener(view ->
                GroupParticipantAdapter.this.blockUserInterface.onBlock(view, position));
