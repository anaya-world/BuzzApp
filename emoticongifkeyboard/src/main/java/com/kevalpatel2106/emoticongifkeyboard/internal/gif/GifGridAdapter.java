...
final class GifGridAdapter extends ArrayAdapter<Gif> {
    ...
    public View getView(final int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (gif != null) {
            DrawableImageViewTarget imageViewTarget = new DrawableImageViewTarget (holder.gifIv,true);
            Glide.with(mContext).load(gif.getPreviewGifUrl()).into(imageViewTarget);
           /* Glide.with(mContext)
